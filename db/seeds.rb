...
user = User.create!(
  ...
  ability: 0,
  bio: "Hey! My name is Pedro. I'm learning how to play the guitar (currently for six months), so hit me up if you wanna make some music!",
...
user = User.create!(
  ...
  dob: Faker::Date.birthday(min_age: 18),
  ability: 3,
  bio: "Hey everyone! My name is Will and i've been playing classical guitar for 20 years, wanna' jam?",
